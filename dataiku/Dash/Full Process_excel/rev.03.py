...
def parse_excel(contents, filename):
    try:
        ...
        combined_df['Area'] = combined_df['Area'].fillna(combined_df.get('Area_extra1')) \
                                                    .fillna(combined_df.get('Area_extra2')) \
                                                    .fillna(combined_df.get('Area_extra3')) \
                                                    .fillna(combined_df.get('Area_extra4'))
