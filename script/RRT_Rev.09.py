...
# 한글 폰트 설정
matplotlib.rcParams['font.family'] = 'Malgun Gothic'  # 'Malgun Gothic'은 윈도우에서 기본으로 제공되는 한글 폰트입니다.
matplotlib.rcParams['axes.unicode_minus'] = False  # 마이너스 기호도 정상 출력되게 합니다.
