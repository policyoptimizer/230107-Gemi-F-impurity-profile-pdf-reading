# Best
# 아래 3가지 영역에 초록색으로 표기함
# 엑셀파일에 df.index 에서 1.29, 1.35, 0.9, 0.94, 0.8, 0.83 의 값이 있어야 함
# 해당 RRT (Y) 값이 없으면 에러남
# imp1_start, imp1_end = df.index.get_loc('1.29'), df.index.get_loc('1.35')
# imp2_start, imp2_end = df.index.get_loc('0.9'), df.index.get_loc('0.94')
# imp3_start, imp3_end = df.index.get_loc('0.8'), df.index.get_loc('0.83')
